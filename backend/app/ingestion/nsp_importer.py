        ...
        for index, scholarship in enumerate(
            ...
            try:
                ...
                if existing:
                    ...
                    existing.opportunity_type = scholarship["opportunity_type"]
                    existing.provider_name = scholarship["provider_name"]
                    existing.description = scholarship["description"]
                    existing.location = scholarship["location"]
                    existing.state = scholarship["state"]
                    existing.application_url = scholarship["application_url"]
                    existing.official_source_url = scholarship["official_source_url"]
                    ...
                    opportunity = Opportunity(
                        ...
                        opportunity_type=scholarship["opportunity_type"],
                ...
                print(
                    f"[{index}/{len(scholarships)}] SKIPPED - {exc}",
                    flush=True,
                )
